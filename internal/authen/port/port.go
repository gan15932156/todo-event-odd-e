...
type UseCase interface {
	...
	UpdateCredential(ctx context.Context, email string, userId string) mo.Result[domain.Credential]
...
type Repository interface {
	...
	FindCredentialByUserIdl(ctx context.Context, userId string) mo.Result[domain.Credential]
